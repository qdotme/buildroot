...
ifeq ($(BR2_PACKAGE_RPI_FIRMWARE_PI3),y)
define RPI_FIRMWARE_INSTALL_PI3 
	$(INSTALL) -D -m 0644 $(@D)/boot/start$(BR2_PACKAGE_RPI_FIRMWARE_BOOT).elf $(BINARIES_DIR)/rpi-firmware/start.elf
	$(INSTALL) -D -m 0644 $(@D)/boot/fixup$(BR2_PACKAGE_RPI_FIRMWARE_BOOT).dat $(BINARIES_DIR)/rpi-firmware/fixup.dat
endef
endif 

ifeq ($(BR2_PACKAGE_RPI_FIRMWARE_PI4),y)
define RPI_FIRMWARE_INSTALL_PI4
	$(INSTALL) -D -m 0644 $(@D)/boot/start$(BR2_PACKAGE_RPI_FIRMWARE_BOOT)4.elf $(BINARIES_DIR)/rpi-firmware/start4.elf
	$(INSTALL) -D -m 0644 $(@D)/boot/fixup$(BR2_PACKAGE_RPI_FIRMWARE_BOOT)4.dat $(BINARIES_DIR)/rpi-firmware/fixup4.dat
endef
endif 

define RPI_FIRMWARE_INSTALL_IMAGES_CMDS
	$(INSTALL) -D -m 0644 $(@D)/boot/bootcode.bin $(BINARIES_DIR)/rpi-firmware/bootcode.bin
	$(RPI_FIRMWARE_INSTALL_PI3)
	$(RPI_FIRMWARE_INSTALL_PI4)
